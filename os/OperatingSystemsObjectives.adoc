...
** *CCOS012.002 Understand Windows TPM Secure/Trusted Boot and BitLocker ²*
...
** *CCOS019.001 Demonstrate intermediate level PowerShell scripting knowledge ²*
...
== Section 8: Linux Auditing & Logging
...
== Section 9: Windows Auditing & Logging
...
== Section 12: Windows Remoting

* *SKILL CCOS035: Enable various components of Windows Remoting ²*
** *CCOS035.001 Discuss the interaction of WinRM & WS-Man ²*
** *CCOS035.002 Discuss the operational limitations of Serialized vs Deserialized objects ²*

* *SKILL CCOS036: Identify the various Remoting Session Types ²*
** *CCOS036.001 Compare PSSession via SSH Transport, Implicit Remoting ²*
** *CCOS036.002 Discuss the differences of SSH Transport and OpenSSH ²*
** *CCOS036.003 Discuss the benefits of Implicit Remoting ²*

== Section 13: Windows Active Directory

* SKILL CCOS037: Understand Windows Active Directory ¹ ²
** CCOS037.001 Understand domain trust relationships ¹
** CCOS037.002 Contrast privilege levels of local domain groups and accounts ¹
...
== Section 15: Understand x86_64 Assembly
...
== Section 16: Determining Binary Behavior
...
== Section 17: Utilize flow of Program
...
== Section 18: Executable Patching
