...
# The ! in the pack format string means network order while the code following specifies how to store the info...B=Byte, H=Half-word, 4s=four bytes (a str is a byte long)
