...
= Activity - Follow a Packet Trhough a Network
...
** Optionally you can download to you host box and use SCP to copy to Net1. "scp /home/username/Downloads/CCTC.pkt username@{net1 floating ip} /home/username"

. Startup Packet Tracer on Net1. Open a Terminal Window and type "packettracer".
...
. Malicious attackers will try to access your network. Connect a straight-thru cable from "Rougue" switch. Click on the lightning bolt icon in the bottom left, then select solid black line icon. 

** Click on the "Rougue" switch and select any of the open ports available. Then click on "CCTC_SW_4" and connect it to port "FastEthernet
 0/20". 

*** What eventually happened? 

*** Can the Rougue PC attain an IP address? 

*** How was this able to happen?

*** What happens if you connected the "Rougue" switch to any other interface?
